...
class CartJSTranslations(BrowserView):
    def __call__(self):
        msgs = dict()
        msgs['total_limit_reached'] = translate(
            _('cart_total_limit_reached', default=u'Total limit reached'),
        ...
        msgs['comment_required'] = translate(
            _('cart_comment_required', default=u'Comment is required'),
            context=self.request,
        )
        msgs['integer_required'] = translate(
            _('cart_integer_required', default=u'Input not an integer'),
            context=self.request,
        )
        msgs['no_longer_available'] = translate(
            _(
        ...
        msgs['item_added'] = translate(
            _('cart_item_added', default=u'Item has been added to cart'),
            context=self.request,
        )
        msgs['item_updated'] = translate(
            _('cart_item_updated', default=u'Item has been updated in cart'),
            context=self.request,
        )
        msgs['item_removed'] = translate(
            _('cart_item_removed', default=u'Item has been removed from cart'),
            context=self.request,
        )
